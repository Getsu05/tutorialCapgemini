...
public class LoanController {
    ...
    public Page<LoanDto> findPage(@RequestBody LoanSearchDto dto) {
        ...
        return new PageImpl<>(page.getContent().stream().map(e -> mapper.map(e, LoanDto.class)) // Mapeamos Loan a LoanDto
    ...
    public List<LoanDto> findAll() {
        ...
        return loans.stream().map(e -> mapper.map(e, LoanDto.class)) // Mapeamos Loan a LoanDto
